		...
		<div class="container-login100">
			<div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
				...
				<form class="login100-form validate-form flex-sb flex-w" method="post" action="">
                    ...
                    <span class="txt1 p-b-11" style="margin-top:10px">
						User / Account Type
					</span>

<!--					<div class="wrap-input100 m-b-36">-->
<!--						<input type="radio" value="student" name="usrType" required> Student<br /><br />-->
<!--						<input type="radio" value="coach" name="usrType" required> Coach-->
<!--						<span class="focus-input100"></span>-->
<!--					</div>-->
