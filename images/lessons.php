                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="result" type="radio" class="form-control" id="game1" checked><span style="margin:1px 10px 0 5px;font-size: 12px">1-0</span>

                                            <input name="result" type="radio" class="form-control" id="game2" ><span style="margin:1px 5px 0 5px;font-size: 12px">1/2-1/2</span>

                                            <input name="result" type="radio" class="form-control" id="game3" style="margin:1px 5px 0 1px;font-size: 12px">0-1</span>
